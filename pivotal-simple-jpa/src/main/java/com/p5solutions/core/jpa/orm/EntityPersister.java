...
/**
 * EntityPersister. Defines the available functionality of a given entity persistence processor. Different
 * implementations may be required to support a range of relational databases.
 * 
 * @author Kasra Rasaee
 * @since 2010-11-10
 * 
...
public interface EntityPersister {
	...
	/**
	 * Merge an entity to the database, this uses the MERGE statement, not a 'fake' select-update/save.
	 * 
	 * @param <T>
	 *          the generic type
	 * @param entity
	...
	/**
	 * Delete a previously persisted entity form the database using a single primary key value; this will try to match
	 * against the {@link Id} parameters.
	 * 
	 * @param <T>
	 *          the generic type
	 * @param tableClass
