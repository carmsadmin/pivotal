...
// TODO cannot be dependent on Oracle components! e.g. Postgres? or MySQL! 
...
public class ConversionUtilityImpl implements ConversionUtility {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.p5solutions.core.jpa.orm.ConversionUtility#convert(com.p5solutions.core.jpa.orm.ParameterBinder , java.lang.Object,
	 * java.lang.Class)
	 */
	@Override
	...
	// TODO this needs to be checked without an actual reference to oracle.sql.TIMESTMAP, as it may not be part of the
	// class path
	...
	protected Object convertSimpleValue(ParameterBinder pb, Object value, String bindingPath, Class<?> sourceType,
		...
		if (isOracleTimeStamp(sourceType)) {
			...
			try {
				...
				throw new RuntimeException("Unable to convert oracle timestamp on parameter binder " + pb.getBindingPath()
						+ " for entity type " + pb.getEntityClass());
			}
		} else if (ReflectionUtility.isClob(sourceType)) {
