...
public class EntityPersisterImpl implements EntityPersister {
	...
	protected Object getJoinColumnValue(Object entity, ParameterBinder pb) {
		...
		if (pb.isOneToOne()) {
			...
			throw new RuntimeException(new NotImplementedException(pb.getEntityClass() + " - "
	...
	public Long executeDML(String sql, Map<String, Object> params) {
		...
		// TODO <Object> should be of type T? how? import org.apache.poi.hssf.record.formula.functions.T;??
	...
	public <T> T saveOrUpdate(T entity) throws Exception {
		...
		if (entity instanceof EntityProxy) {
			...
			if (context.exists(entityKey)) {
				...
				// check the fetch-before-save to see whether we're doing the save or not
				if (isFetchBeforeSaveWarranted(entityClass)) {
					// save it only if it is not already saved (not in context at this point)
	 ...
	 * @see com.p5solutions.core.jpa.orm.EntityPersister#setConversionUtility(com.p5solutions.core.jpa.orm .ConversionUtility)
	 */
	@Override
	 ...
	 * @see com.p5solutions.core.jpa.orm.EntityPersister#setTransactionTemplate(com.p5solutions.core. orm.transaction.TransactionTemplate)
	 */
	@Override
	 ...
	 * @see com.p5solutions.core.jpa.orm.EntityPersister#setInterceptorUtility(com.p5solutions.core.jpa.orm .InterceptorUtility)
	 */
	@Override
