		...
		SqlParameterSource ps = new SqlParameterSource() {
			...
			protected final void throwQueryNullException() {
				...
				if (conversionUtility == null) {
					throw new NullPointerException("Conversion Utility cannot be null when generating new SQL Parameter Source"
							+ this);
				}
			}
			...
			public Object getValue(String paramName) throws IllegalArgumentException {
				...
				try {
					...
					throw new RuntimeException("Unable convert value " + value + " to target type " + qc.getBindingType()
							+ ", please check target class " + (query.getEntityClass() != null ? query.getEntityClass() : "<NULL>")
