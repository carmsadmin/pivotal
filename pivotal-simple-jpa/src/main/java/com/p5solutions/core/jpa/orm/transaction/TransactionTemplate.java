...
public interface TransactionTemplate {
	...
	// PERSIST METHODS
	/**
	 * Save an entity that is not currently in the database, this issues an INSERT statement.
	 * 
	 * @param <T>
	 *          the generic type
	 * @param entity
	...
	/**
	 * Update an entity that is already within the database context, this issues an UPDATE statement.
	 * 
	 * @param <T>
	 *          the generic type
	 * @param entity
	...
	/**
	 * Merge an existing or new entity to the database context, this issues a MERGE statement.
	 * 
	 * @param <T>
	 *          the generic type
	 * @param entity
	...
	/**
	 * Save or update an entity based on whether the primary key is set to null or not, if the primary key is not set,
	 * then it will issue {@link #save(Object)}, otherwise an {@link #update(Object)}. Considering using
	 * {@link #merge(Object)}
	 * 
	 * @param <T>
	 *          the generic type
	...
	/**
	 * List of results from a named query. Result entity class extracted from the query name. Requires the name to be
	 * prefixed with a Class name followed by a dot. Example: "Document.medproDocs"
	 * 
	 * @param queryName
	 * @param keyValue
	 * @return
	...
	/**
	 * List of results from a named query. Result entity class specified as a parameter.
	 * 
	 * @param <T>
	 * @param clazz
	 * @param queryName
