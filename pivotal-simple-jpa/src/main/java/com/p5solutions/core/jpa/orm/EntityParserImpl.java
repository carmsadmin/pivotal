...
public class EntityParserImpl implements EntityParser {
	 ...
	 */
	protected <T> RowMapper<T> getRowMapper(Class<T> entityClass, String currentQueryIdentifier,
			DependencyJoinFilter joinFilter) {
		...
		if (isPlainClass || isBasicClass || entityClass == null) {
			...
			rowMapper = new EntityRowBinder<T>(entityClass, getEntityUtility(), getMapUtility(), currentQueryIdentifier,
					joinFilter, this);
		}
		return rowMapper;
	}
	...
	/**
	 * @see com.p5solutions.core.jpa.orm.EntityParser#findSingleResultByQuery(java.lang.Class,
	 *      com.p5solutions.core.jpa.orm.Query, com.p5solutions.core.jpa.orm.DependencyJoinFilter)
	 */
	@Override
	...
	/**
	 * @see com.p5solutions.core.jpa.orm.EntityParser#find(java.lang.Class, java.lang.Object)
	 */
	@Override
