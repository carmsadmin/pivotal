...
public class ReflectionUtility {
   ...
   * @return the method
   */
  public static Method findSetterMethod(Class<?> clazz, String fieldName, boolean ignoreParamSearch, Class<?>... paramTypes) {
    String set = "set";
    String firstLetter = fieldName.substring(0, 1).toUpperCase();
    set += firstLetter + fieldName.substring(1);
  ...
  public static String getMethodSignature(Method method) {
    ...
    StringBuilder sb = new StringBuilder(method.getReturnType().getSimpleName()).append("_").append(method.getName()).append("(_");
  ...
  public static Method findMethod(Class<?> clazz, String methodName, boolean ignoreParamSearch, Class<?>... paramTypes) {
    ...
    for (Method m : clazz.getDeclaredMethods()) {
      ...
      if (!ignoreParamSearch && checkParams(m, paramTypes)) {
        ...
        throw new RuntimeException("Multiple methods found, please specify a list of parameter types to refine your method search.");
      }
  ...
  public static String getStackTrace(Throwable e) {
    ...
    try {
      ...
      logger.error("Error in closing the output stream for byte array when getting stack trace on exception " + e.toString());
    }
    return "";
  }
