...
/**
 * AbstractMethodHandler: abstraction for method handler/invokers (equivalent to
 * cglib's callback/interceptors). Use this as a base to be implemented in all
 * concrete level byte code method handlers using {@link ProxyFactory}
 * 
 * @author Kasra Rasaee
